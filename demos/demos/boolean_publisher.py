"""boolean_publisher.py
   ...
   Publish a single boolean, as set by a GUI checkbox.

   This generates a bool message.

   Node:        /boolean
   Publish:     /boolean                std_msgs.msg.Bool
"""
...
class GUINode(Node):
    ...
    # Callback from the GUI to set the boolean.
    def CB(self, v):
        # Set the value.
        self.boolean.data = v
